...
INSERT INTO `colegio` (`id_colegio`, `nombre`, `rector`, `direccion`, `modalidad`, `foto`) VALUES
	(1, 'Institucion Educativa Tecnico Agroecologico el Motilon', 'Jesus Javier Pantoja Martinez', 'Barrio Shumaker', 'Agroecologica', NULL);
...
INSERT INTO `cronograma` (`id_cronograma`, `fecha`, `hora`, `tipo`, `nombre`, `descripcion`, `responsable`, `foto`) VALUES
...
INSERT INTO `docente` (`id_docente`, `id_usuario`, `grado`, `id_materia`) VALUES
	(1, 1, '2a', 4);
...
INSERT INTO `formulario` (`id_formulario`, `nombre`, `categoria`, `descripcion`, `documento`, `formato`) VALUES
...
INSERT INTO `usuario` (`id_usuario`, `identificacion`, `nombres`, `apellidos`, `telefono`, `email`, `login`, `password`, `perfil`, `foto`) VALUES
	(1, 1088734444, 'Paola Andrea', 'Melo Andrade', '3218956472', 'andrea_meloo@hotmail.com', 'paola123', '1088734444', 'docente', NULL),
	(2, 1030022337, 'Hanna Valentina', 'Rodriguez Vacca', NULL, NULL, 'hanna123', '1030022337', 'estudiante', NULL),
	(3, 59795787, 'Julieta ', 'Montenegro', '3187649994', 'julieta@gmail.com', 'julieta123', '59795787', 'secretaria', NULL);
